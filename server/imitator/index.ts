...
class Imitator {
  ...
  private generateResponse(): Response {
    const newBidsAmount = Math.floor(
      this.generateFloatInRange(
        bidsGenerateAmountLowerBound,
        bidsGenerateAmountUpperBound,
      ),
    );
    const newAsksAmount = Math.floor(
      this.generateFloatInRange(
        asksGenerateAmountLowerBound,
        asksGenerateAmountUpperBound,
      ),
    );
    ...
    if (Math.random() > chanceToDeleteBids) {
      const deleteAmount = Math.floor(
        this.generateFloatInRange(
          bidsDeleteAmountLowerBound,
          bidsDeleteAmountUpperBound,
        ),
      );
    ...
    if (Math.random() > chanceToDeleteAsks) {
      const deleteAmount = Math.floor(
        this.generateFloatInRange(
          asksDeleteAmountLowerBound,
          asksDeleteAmountUpperBound,
        ),
      );
  ...
  private generateLastDealPrice(): number {
    return this.generateFloatInRange(
      lastDealPriceLowerBound,
      lastDealPriceUpperBound,
    );
  }
